...
class CNN(object):
    def __init__(self, conv_poll_layer_sizes, hidden_layer_sizes):
        self.convpool_layer_sizes = convpoll_layer_sizes
    ...
    def fit(self, X, Y, lr=10e-5, mu=0.99, reg=10e-7, decay=0.99999, eps=10e-3, batch_sz=30, epochs=100, show_fig=True):
        ...
        for mo, fw, fh in self.convpool_layer_sizes:
            layer = ConvPollLayer(mi, mo, fw, fh)
